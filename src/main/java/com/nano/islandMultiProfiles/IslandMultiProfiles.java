...
import com.nano.islandMultiProfiles.infra.command.IMCmdSubIslandCreate;
...
public final class IslandMultiProfiles extends JavaPlugin {
    ...
    private void onCommand(){
        SuperiorSkyblockAPI.getCommands().registerCommand(new IMCmdSubIslandCreate(islandService));
